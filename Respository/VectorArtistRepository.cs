...
public interface IVectorArtistRepository
{
    Task<ApiResponse> GetMyVectorOrdersAsync(string userId, string OrderId);
    Task<ApiResponse> UploadVectorOrderAsync(MediaViewModel mediaViewModel, string userId, string OrderId);

}
public class VectorArtistRepository : IVectorArtistRepository
{
    ...
    public async Task<ApiResponse> GetMyVectorOrdersAsync(string userId, string OrderId)
    {
        try
        {
            ...
            var result = await (from assignOrder in _context.AssignOrders
                                ...
                                select new GetAllVectorOrdersVM
                                {
                                    Id = order.Id,
                                    PoNo = order.PoNo,
                                    Date = order.Date,
    ...
    public async Task<ApiResponse> UploadVectorOrderAsync(MediaViewModel mediaViewModel, string userId, string OrderId)
    {
        try
        {
            if (string.IsNullOrEmpty(userId))
